    ...
    return (
      <div className="max-w-md mx-auto px-4 py-16" id="admin-login-view">
        <div className="bg-white border border-gray-100 rounded-3xl p-8 shadow-sm">
          ...
          <h1 className="font-display font-bold text-2xl text-gray-900 text-center">Seller Portal Login</h1>
          <p className="text-gray-500 mt-2 text-sm text-center">
            Authenticate to manage products, settings, and view customer orders.
          </p>

          {/* Prompt highlighting password */}
          <div className="mt-5 p-3.5 bg-indigo-50 text-indigo-800 rounded-2xl border border-indigo-100 text-xs flex items-start space-x-2">
            ...
            <div>
              ...
              <p className="mt-0.5 text-indigo-700 font-medium">Use the password <code className="bg-white px-1.5 py-0.5 rounded border border-indigo-200 font-mono font-bold text-xs text-indigo-900">admin123</code> to enter immediately.</p>
            </div>
          </div>
          ...
          <form onSubmit={handleLogin} className="mt-6 space-y-4">
            ...
            <button
              type="submit"
              disabled={isLoggingIn}
              className="w-full bg-indigo-600 hover:bg-indigo-700 text-white font-semibold py-3 px-4 rounded-xl shadow-md shadow-indigo-100 transition-colors flex items-center justify-center space-x-2 cursor-pointer text-sm"
                    ...
                    <div key={o.id} className="border border-gray-100 rounded-2xl p-5 shadow-sm bg-gray-50/30">
                      <div className="flex flex-col sm:flex-row justify-between sm:items-center border-b border-gray-200/50 pb-3 mb-4 gap-2">
                        ...
                        <div className="text-right">
                          ...
                          <span className="inline-flex items-center text-xxs font-semibold bg-emerald-50 text-emerald-700 px-2 py-0.5 rounded border border-emerald-100 mt-0.5 uppercase">
                            Recorded
                          </span>
                        </div>
                      </div>
